...
setwd("C:/Users/Rohit/OneDrive - Universität Münster/Paper Drafts/G-cubed/Figures/Figure 3/")
...
text(340,1200,"(b) Custom windows reflecting datums", cex = 1.75)
...
text(x = 900, y = 5000,"(c) Cumulative cost within custom window", cex = 1.75)
