...
Goodwyn2 <- read.csv("C:/Users/Rohit/OneDrive - Universität Münster/NOPIMS Data/NW_Australia_Digitized_Data/Carnarvon Basin/Goodwyn 2/Goodwyn2.csv", header=TRUE, stringsAsFactors=FALSE)
